...
* **deps:** update rust crate serde_json to v1.0.106 ([9795205](https://github.com/typescript-tools/rust-implementation/commit/9795205d46e28f4ab6418a521ec6000ec152ac22))

## [8.0.51](https://github.com/typescript-tools/rust-implementation/compare/v8.0.50...v8.0.51) (2023-09-01)


### Bug Fixes

* **deps:** update rust crate clap to v4.4.2 ([c28e32e](https://github.com/typescript-tools/rust-implementation/commit/c28e32e44a8beaef9ec448636303ff436e2f155e))

## [8.0.50](https://github.com/typescript-tools/rust-implementation/compare/v8.0.49...v8.0.50) (2023-08-29)


### Bug Fixes

* **deps:** update rust crate clap to v4.4.1 ([30a6275](https://github.com/typescript-tools/rust-implementation/commit/30a62751e2c305baceaae5850ad30fbc66b8d7c0))

## [8.0.49](https://github.com/typescript-tools/rust-implementation/compare/v8.0.48...v8.0.49) (2023-08-26)


### Bug Fixes

* **deps:** update rust crate serde to v1.0.188 ([56ce951](https://github.com/typescript-tools/rust-implementation/commit/56ce95143d60deaef297b3b14e8c106e0d6a6955))

## [8.0.48](https://github.com/typescript-tools/rust-implementation/compare/v8.0.47...v8.0.48) (2023-08-25)


### Bug Fixes

* **deps:** update rust crate clap to v4.4.0 ([618e8f9](https://github.com/typescript-tools/rust-implementation/commit/618e8f9b3f612c08f34407836f6be727745c9da0))

## [8.0.47](https://github.com/typescript-tools/rust-implementation/compare/v8.0.46...v8.0.47) (2023-08-24)


### Bug Fixes

* **deps:** update rust crate serde to v1.0.186 ([d406757](https://github.com/typescript-tools/rust-implementation/commit/d406757b072cd0941e53459ae8d53914461ce739))

## [8.0.46](https://github.com/typescript-tools/rust-implementation/compare/v8.0.45...v8.0.46) (2023-08-24)


### Bug Fixes

* **deps:** update rust crate clap to v4.3.24 ([d4c020e](https://github.com/typescript-tools/rust-implementation/commit/d4c020ea9510f9ba744e25ca4bf4c8ce637c8e9e))
...
* **deps:** update rust crate clap to v4.3.23 ([aff4ff7](https://github.com/typescript-tools/rust-implementation/commit/aff4ff7a1fd09579f68f71d17e61e5c8e6d808fc))
...
* **deps:** update rust crate serde_json to v1.0.105 ([800598f](https://github.com/typescript-tools/rust-implementation/commit/800598fd60ce561479ea9ab862f184a2df7d1ca4))

## [8.0.41](https://github.com/typescript-tools/rust-implementation/compare/v8.0.40...v8.0.41) (2023-08-08)


### Bug Fixes

* **deps:** update rust crate clap to v4.3.21 ([bd6c973](https://github.com/typescript-tools/rust-implementation/commit/bd6c97369296cb4e6da43e298bf1b8dbf9032ce0))

## [8.0.40](https://github.com/typescript-tools/rust-implementation/compare/v8.0.39...v8.0.40) (2023-08-07)


### Bug Fixes

* **deps:** update rust crate serde to v1.0.183 ([ba9df47](https://github.com/typescript-tools/rust-implementation/commit/ba9df476b28e4129935e332f4474081721619036))

## [8.0.39](https://github.com/typescript-tools/rust-implementation/compare/v8.0.38...v8.0.39) (2023-08-06)


### Bug Fixes

* **deps:** update rust crate serde to v1.0.182 ([d66858a](https://github.com/typescript-tools/rust-implementation/commit/d66858a29fc31d1245efabfec26e292832d01e53))

## [8.0.38](https://github.com/typescript-tools/rust-implementation/compare/v8.0.37...v8.0.38) (2023-08-04)


### Bug Fixes

* **deps:** update rust crate serde to v1.0.181 ([65f24d0](https://github.com/typescript-tools/rust-implementation/commit/65f24d01d6ce6b0067447a9934b77dba650072e2))

## [8.0.37](https://github.com/typescript-tools/rust-implementation/compare/v8.0.36...v8.0.37) (2023-08-01)


### Bug Fixes

* **deps:** update rust crate serde to v1.0.180 ([c143023](https://github.com/typescript-tools/rust-implementation/commit/c14302355a1a82777ef863dd11e2bcff07334dfa))

## [8.0.36](https://github.com/typescript-tools/rust-implementation/compare/v8.0.35...v8.0.36) (2023-07-31)


### Bug Fixes

* **deps:** update rust crate serde to v1.0.179 ([94c8d24](https://github.com/typescript-tools/rust-implementation/commit/94c8d24c19246a17f017ed9301d92cf2670a658b))

## [8.0.35](https://github.com/typescript-tools/rust-implementation/compare/v8.0.34...v8.0.35) (2023-07-29)


### Bug Fixes

* **deps:** update rust crate serde to v1.0.178 ([6e94a70](https://github.com/typescript-tools/rust-implementation/commit/6e94a70114ef91d8b4c0019a32e52ada90c227fe))
...
* **deps:** update rust crate serde to v1.0.176 ([91e1ea7](https://github.com/typescript-tools/rust-implementation/commit/91e1ea73e55158f37a691da9a0b583158104d2e1))
...
* **deps:** update rust crate clap to v4.3.19 ([2c79eea](https://github.com/typescript-tools/rust-implementation/commit/2c79eeab8e8e5451a6f1663cdc6080b22ff26346))

## [8.0.29](https://github.com/typescript-tools/rust-implementation/compare/v8.0.28...v8.0.29) (2023-07-21)


### Bug Fixes

* **deps:** update rust crate serde to v1.0.174 ([fde768c](https://github.com/typescript-tools/rust-implementation/commit/fde768cf91d6d2c6495538a9c2a2e2c6409a9675))

## [8.0.28](https://github.com/typescript-tools/rust-implementation/compare/v8.0.27...v8.0.28) (2023-07-20)


### Bug Fixes

* **deps:** update rust crate serde to v1.0.173 ([62fd27f](https://github.com/typescript-tools/rust-implementation/commit/62fd27fd673b324e69926979ac1631ddff41b34a))

## [8.0.27](https://github.com/typescript-tools/rust-implementation/compare/v8.0.26...v8.0.27) (2023-07-20)


### Bug Fixes

* **deps:** update rust crate clap to v4.3.17 ([4a3f5eb](https://github.com/typescript-tools/rust-implementation/commit/4a3f5ebe304065b1f58c782335f31f9a9e23ca84))

## [8.0.26](https://github.com/typescript-tools/rust-implementation/compare/v8.0.25...v8.0.26) (2023-07-19)


### Bug Fixes

* **deps:** update rust crate clap to v4.3.16 ([2934f7b](https://github.com/typescript-tools/rust-implementation/commit/2934f7b9f9ad90d6d48997c03d03f278a464a623))

## [8.0.25](https://github.com/typescript-tools/rust-implementation/compare/v8.0.24...v8.0.25) (2023-07-18)


### Bug Fixes

* **deps:** update rust crate clap to v4.3.15 ([be06c86](https://github.com/typescript-tools/rust-implementation/commit/be06c8656121327f5e59e2e1fc810798d746be53))

## [8.0.24](https://github.com/typescript-tools/rust-implementation/compare/v8.0.23...v8.0.24) (2023-07-16)


### Bug Fixes

* **deps:** update rust crate serde_json to v1.0.103 ([e9d45c0](https://github.com/typescript-tools/rust-implementation/commit/e9d45c0639a54e8bf186612e94d7601b60f84580))

## [8.0.23](https://github.com/typescript-tools/rust-implementation/compare/v8.0.22...v8.0.23) (2023-07-15)


### Bug Fixes

* **deps:** update rust crate clap to v4.3.12 ([ba6662c](https://github.com/typescript-tools/rust-implementation/commit/ba6662c98eb5673cdcfd2c3eae18a8b7aaa9479e))

## [8.0.22](https://github.com/typescript-tools/rust-implementation/compare/v8.0.21...v8.0.22) (2023-07-12)


### Bug Fixes

* **deps:** update rust crate serde_json to v1.0.102 ([58b849a](https://github.com/typescript-tools/rust-implementation/commit/58b849a7026eb125e26c014c962eca5507b52afa))

## [8.0.21](https://github.com/typescript-tools/rust-implementation/compare/v8.0.20...v8.0.21) (2023-07-10)


### Bug Fixes

* **deps:** update rust crate serde to v1.0.171 ([6826d28](https://github.com/typescript-tools/rust-implementation/commit/6826d28f7ce7c1103fa753418439a7a28f59a2be))

## [8.0.20](https://github.com/typescript-tools/rust-implementation/compare/v8.0.19...v8.0.20) (2023-07-10)


### Bug Fixes

* **deps:** update rust crate serde to v1.0.170 ([53b259d](https://github.com/typescript-tools/rust-implementation/commit/53b259d679b0de7c30daa948f2ba960bbed39c64))

## [8.0.19](https://github.com/typescript-tools/rust-implementation/compare/v8.0.18...v8.0.19) (2023-07-09)


### Bug Fixes

* **deps:** update rust crate serde to v1.0.169 ([bb10276](https://github.com/typescript-tools/rust-implementation/commit/bb1027682439de81aaa46528dff1788ebfb5e68c))

## [8.0.18](https://github.com/typescript-tools/rust-implementation/compare/v8.0.17...v8.0.18) (2023-07-09)


### Bug Fixes

* **deps:** update rust crate serde to v1.0.168 ([0bf6197](https://github.com/typescript-tools/rust-implementation/commit/0bf6197bac33a097d593460182661455d25e7b7e))

## [8.0.17](https://github.com/typescript-tools/rust-implementation/compare/v8.0.16...v8.0.17) (2023-07-07)


### Bug Fixes

* **deps:** update rust crate serde to v1.0.167 ([00836a2](https://github.com/typescript-tools/rust-implementation/commit/00836a271dc43cf4f6d8492c2de464684473b970))

## [8.0.16](https://github.com/typescript-tools/rust-implementation/compare/v8.0.15...v8.0.16) (2023-07-06)


### Bug Fixes

* **deps:** update rust crate clap to v4.3.11 ([da74e77](https://github.com/typescript-tools/rust-implementation/commit/da74e77abb4793b84caf874221d5049427647e4f))
